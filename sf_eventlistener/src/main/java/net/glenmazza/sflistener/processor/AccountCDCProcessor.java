...
import net.glenmazza.sflistener.model.AccountCDCEvent;
import net.glenmazza.sflistener.model.AccountCDCEvent.Payload;
import net.glenmazza.sflistener.model.BaseCDCEvent.BasePayload.ChangeEventHeader.ChangeType;
...
import static net.glenmazza.sflistener.model.BaseCDCEvent.*;
import static net.glenmazza.sflistener.model.BaseCDCEvent.BasePayload.ChangeEventHeader.ChangeType.UNDELETE;

@Component
public class AccountCDCProcessor extends BaseCDCProcessor {
    ...
    public AccountCDCProcessor(@Value("${salesforce.cometd.accountCdcChannel:}") String channel,
                               @Value("${salesforce.cometd.accountCdcReplayId:0}") long replayId) {
