...
import net.glenmazza.marketoclient.marketoclient.model.GiftingLeadRecord;
import net.glenmazza.marketoclient.marketoclient.model.GiftingLeadWithIDRecord;
...
import net.glenmazza.marketoclient.marketoclient.model.leads.LeadUpsertResponse.Result.Status;
...
public class LeadServiceTest {
    ...
    @Test
    void testLeadMaintenanceViaMapExceptions() throws JsonProcessingException {
        List<Map<String, Object>> inputItems = new ArrayList<>();
