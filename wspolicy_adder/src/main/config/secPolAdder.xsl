...
<xsl:stylesheet version="1.0"
   ...
   <xsl:template match="wsdl:definitions">
       ...
       <xsl:copy>
          ...
          &ivSp;<wsp:Policy wsu:Id="DoubleItBindingPolicy" 
          ...
          <xsl:when test="$security.method = 'X509'">
                <sp:SignedSupportingTokens xmlns:wsp="http://schemas.xmlsoap.org/ws/2004/09/policy" 
                 xmlns:sp="http://schemas.xmlsoap.org/ws/2005/07/securitypolicy" 
                 xmlns:wsaw="http://www.w3.org/2005/08/addressing">
                   <wsp:Policy>
                      <sp:UsernameToken
          ...
          <xsl:otherwise>
              <sp:Layout xmlns:wsp="http://schemas.xmlsoap.org/ws/2004/09/policy" 
                 xmlns:sp="http://schemas.xmlsoap.org/ws/2005/07/securitypolicy" 
                 xmlns:wsaw="http://www.w3.org/2005/08/addressing">
                 <wsp:Policy>
                    <sp:Lax />
